...
/// <summary>
///     Provides extension methods for <see cref="Type" />s.
/// </summary>
public static class TypeExtensions
{
    /// <summary>
    ///     Determines if the given <paramref name="type" /> is an enumerable of some kind.
    /// </summary>
    /// <param name="type">
    ///     The <see cref="Type" /> to examine.
    /// </param>
    /// <returns>
    ///     A value indicating whether then given <paramref name="type" /> is <see cref="IEnumerable" />.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     A <see cref="Type" /> representing the element type if <paramref name="type" /> is an enumerable.  Otherwise the given type.
    /// </returns>
