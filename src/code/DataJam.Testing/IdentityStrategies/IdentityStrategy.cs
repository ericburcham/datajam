...
/// <summary>
///     A base class for identity strategies.
/// </summary>
/// <typeparam name="T">
///     The element Type.
/// </typeparam>
    ...
    where T : class
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="IdentityStrategy{T, TIdentity}" /> class.
    /// </summary>
    /// <param name="propertyExpression">
    ///     An expression identifying the identity property.
    /// </param>
    ...
    /// <summary>
    ///     Gets or sets the function used to set the identity.
    /// </summary>
    ...
    ///     Thrown if the <see cref="Generator" /> is null.
    /// </exception>
    ...
    /// </param>
    /// <returns>
    ///     A value indicating whether the default value for this identity strategy is unset.
    /// </returns>
