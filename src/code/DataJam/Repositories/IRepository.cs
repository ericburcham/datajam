...
public interface IRepository
{
    ...
    /// </param>
    /// <returns>
    ///     An enumerable of items matching the specified query.
    /// </returns>
    ...
    /// </typeparam>
    /// <param name="scalar">
    ///     The scalar query to execute.
    /// </param>
    /// <returns>
    ///     The item matching the specified scalar query.
    /// </returns>
    ...
    ///     The type of the items to project.
    /// </typeparam>
    /// <param name="query">
    ///     The query to execute.
    /// </param>
    /// <returns>
    ///     An enumerable of projection items matching the specified query.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains the item matching the specified scalar query.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains an enumerable of items matching the specified query.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains an enumerable of projection items matching the specified query.
    /// </returns>
