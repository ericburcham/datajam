...
/// <summary>
///     Provides a base class for domains.
/// </summary>
/// <typeparam name="TConfigurationBinder">
///     The concrete type that is used to bind the configuration.
/// </typeparam>
/// <typeparam name="TConfigurationOptions">
///     The concrete type that is used to carry configuration options.
/// </typeparam>
...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="Domain{TConfigurationBinder,TConfigurationOptions}" /> class.
    /// </summary>
    /// <param name="configurationOptions">
    ///     The configuration options.
    /// </param>
    /// <param name="mappingConfigurator">
    ///     The mapping configurator.
    /// </param>
