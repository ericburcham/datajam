...
/// <summary>
///     Provides a disposable unit of work that is capable of both read and write operations and which is organized around a domain.
/// </summary>
...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="DomainContext{TDomain}" /> class.
    /// </summary>
    /// <param name="domain">
    ///     The domain to use.
    /// </param>
